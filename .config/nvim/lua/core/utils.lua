...
M.messages = {
  ...
  config_snacks_failed    = { "Snacks failed to load", levels.ERROR },
  config_treesitter_failed = { "Treesitter failed to load", levels.ERROR },
  config_completion_failed = { "Completion failed to load", levels.ERROR },
  config_mason_failed     = { "Mason failed to load", levels.ERROR },
  config_mason_lspconfig_failed = { "Mason LSP integration failed to load", levels.ERROR },
  config_module_failed    = { "Configuration module failed to load", levels.ERROR },
