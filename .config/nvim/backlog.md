...
- [x] Move blink.cmp configuration and SQL sorting into `completion.lua`.
...
- [x] Keep Diffview configuration and review UI behavior in `plugins/diffview.lua`.
- [x] Keep only lazy-loading and user-facing keymaps under `core/keymaps/diffview.lua`.
- [x] Preserve reviewed-file markers, base-branch selection, hover, and relative-path copy.
...
- [x] Run `:checkhealth` after the final refactor.
